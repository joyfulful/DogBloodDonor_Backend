...
if ($selecttimerange == "yearly") {
    ...
    if($month == $smonth & $year == $syear){
        echo 'title: "Top Request Dog Blood Type In ' . date("F", strtotime("2000-$smonth-01")) . ' ' . $syear . '",';
    }else{
        echo 'title: "Top Request Dog Blood Type Between ' . date("F", strtotime("2000-$smonth-01")) . ' ' . $syear . " to ". date("F", strtotime("2000-$month-01")) . ' ' . $year . '",';
    }
}
?>
            width: "100%",
