...
if ($user_id != 0) {
    // User Data Query
    $res = $con->query("SELECT user.email as email, user_profile.firstname as fname, user_profile.lastname as lname,
        user_profile.telno, user_profile.house_no, data_subdistrict.subdistrict_NAME, data_district.district_name, 
        data_province.PROVINCE_NAME,user_profile.postcode,user_profile.user_image, user.activate_status, user.user_type ,
